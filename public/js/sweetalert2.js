...
(function (global, factory) {
    ...
    var isThenable = function isThenable(arg) {
        return (
            arg && _typeof(arg) === "object" && typeof arg.then === "function"
        );
    };
        ...
        if (params.type) {
            if (Object.keys(iconTypes).indexOf(params.type) !== -1) {
                ...
                if (params.animation) {
                    addClass(
                        icon,
                        "swal2-animate-".concat(params.type, "-icon")
                    );
                }
            } else {
                error(
            ...
            (function (_ParentSwal) {
                ...
                function SwalWithGlobalDefaults() {
                    ...
                    return _possibleConstructorReturn(
                        this,
                        _getPrototypeOf(SwalWithGlobalDefaults).apply(
                            this,
                            arguments
                        )
                    );
